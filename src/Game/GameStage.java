...
public class GameStage extends PApplet{
	...
	public void setup() {
		...
		smooth();
		self = this;
		this.books = loadImage("res/books.png");
		this.bullet = loadImage("res/bullet.png");
		this.book = loadImage("res/book.png");
		this.bloodletter = loadImage("res/bloodletter.png");
		this.phone = loadImage("res/phone.png");
		this.diamand = loadImage("res/diamand.png");
		this.skull = loadImage("res/skull.png");
		this.man = loadImage("res/man2.png");
		this.man1 = loadImage("res/man_run1.png");
		this.man2 = loadImage("res/man_run2.png");
		this.man3 = loadImage("res/man_run3.png");
		this.man4 = loadImage("res/man_run4.png");
		this.man5 = loadImage("res/man_run5.png");
		this.man6 = loadImage("res/man_run6.png");
		this.man7 = loadImage("res/man_run7.png");
		this.man8 = loadImage("res/man_run8.png");
		this.man_c1 = loadImage("res/man_climb1.png");
		this.man_c2 = loadImage("res/man_climb2.png");
		this.man_s1 = loadImage("res/man_sit1.png");
		this.man_s2 = loadImage("res/man_sit2.png");
		this.dead_man = loadImage("res/man_die.png");
		this.kidnap = loadImage("res/kidnap.png");
		this.kidnap2 = loadImage("res/kidnap2.png");
		this.cellphone = loadImage("res/phone.png");
		int i;
		for(i = 1; i <= 8; i++){
			this.man_a[i] = loadImage("res/man_gun"+Integer.toString(i)+".png");
		}
		this.monster = loadImage("res/monster.png");
		this.monster2 = loadImage("res/monster2.png");
		this.strike = loadImage("res/strike.png");
		this.box = loadImage("res/box.png");
		this.bed = loadImage("res/bed.png");
		this.ladder = loadImage("res/lader.png");
		this.door1 = loadImage("res/closedoor.png");
		this.door2 = loadImage("res/opendoor.png");
		this.fireBall1 = loadImage("res/fireball.png");
		this.fireBall2 = loadImage("res/fireball2.png");
		...
		song=minim.loadFile("res/shadow.wav");
		song.loop();
		effect[0]=minim.loadFile("res/shoot.wav");
		effect[1]=minim.loadFile("res/levelUp.wav");
